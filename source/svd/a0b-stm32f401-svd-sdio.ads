...
package A0B.STM32F401.SVD.SDIO is
   pragma Preelaborate;
   ...
   subtype POWER_PWRCTRL_Field is A0B.Types.SVD.UInt2;
   ...
   subtype CLKCR_CLKDIV_Field is A0B.Types.SVD.Byte;
   subtype CLKCR_WIDBUS_Field is A0B.Types.SVD.UInt2;
   ...
   subtype CMD_CMDINDEX_Field is A0B.Types.SVD.UInt6;
   subtype CMD_WAITRESP_Field is A0B.Types.SVD.UInt2;
   ...
   subtype RESPCMD_RESPCMD_Field is A0B.Types.SVD.UInt6;
   ...
   subtype DLEN_DATALENGTH_Field is A0B.Types.SVD.UInt25;
   ...
   subtype DCTRL_DBLOCKSIZE_Field is A0B.Types.SVD.UInt4;
   ...
   subtype DCOUNT_DATACOUNT_Field is A0B.Types.SVD.UInt25;
   ...
   type ICR_Register is record
      ...
      --  unspecified
      Reserved_11_21 : A0B.Types.SVD.UInt11 := 16#0#;
   ...
   subtype FIFOCNT_FIFOCOUNT_Field is A0B.Types.SVD.UInt24;
   ...
   type SDIO_Peripheral is record
      ...
      --  argument register
      ARG     : aliased A0B.Types.SVD.UInt32;
      --  command register
      ...
      RESP1   : aliased A0B.Types.SVD.UInt32;
      --  response 1..4 register
      RESP2   : aliased A0B.Types.SVD.UInt32;
      --  response 1..4 register
      RESP3   : aliased A0B.Types.SVD.UInt32;
      --  response 1..4 register
      RESP4   : aliased A0B.Types.SVD.UInt32;
      --  data timer register
      DTIMER  : aliased A0B.Types.SVD.UInt32;
      --  data length register
      ...
      --  data FIFO register
      FIFO    : aliased A0B.Types.SVD.UInt32;
   end record
     with Volatile;
