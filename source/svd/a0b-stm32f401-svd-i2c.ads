...
package A0B.STM32F401.SVD.I2C is
   pragma Preelaborate;
   ...
   subtype CR2_FREQ_Field is A0B.Types.SVD.UInt6;
   ...
   subtype OAR1_ADD7_Field is A0B.Types.SVD.UInt7;
   subtype OAR1_ADD10_Field is A0B.Types.SVD.UInt2;
   ...
   subtype OAR2_ADD2_Field is A0B.Types.SVD.UInt7;
   ...
   subtype DR_DR_Field is A0B.Types.SVD.Byte;
   ...
   subtype SR2_PEC_Field is A0B.Types.SVD.Byte;
   ...
   subtype CCR_CCR_Field is A0B.Types.SVD.UInt12;
   ...
   subtype TRISE_TRISE_Field is A0B.Types.SVD.UInt6;
