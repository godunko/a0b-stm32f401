...
package A0B.STM32F401.SVD.TIM is
   pragma Preelaborate;
   ...
   subtype OR_ITR1_RMP_Field is A0B.Types.SVD.UInt2;

   --  TIM5 option register
   type OR_Register is record
      --  unspecified
      Reserved_0_9   : A0B.Types.SVD.UInt10 := 16#0#;
      --  Timer Input 4 remap
   ...
   subtype OR_IT4_RMP_Field is A0B.Types.SVD.UInt2;
   ...
   subtype CCMR1_Input_IC1F_Field_1 is A0B.Types.SVD.UInt3;
   subtype CCMR1_Input_IC2F_Field_1 is A0B.Types.SVD.UInt3;
   ...
   type CR1_Register_2 is record
      ...
      URS            : Boolean := False;
      --  unspecified
      Reserved_3_6   : A0B.Types.SVD.UInt4 := 16#0#;
      --  Auto-reload preload enable
      ARPE           : Boolean := False;
      --  Clock division
      CKD            : CR1_CKD_Field := 16#0#;
   ...
   type SR_Register_3 is record
      ...
      CC1IF          : Boolean := False;
      --  unspecified
      Reserved_2_8   : A0B.Types.SVD.UInt7 := 16#0#;
      --  Capture/Compare 1 overcapture flag
      CC1OF          : Boolean := False;
      --  unspecified
      Reserved_10_31 : A0B.Types.SVD.UInt22 := 16#0#;
   ...
   subtype OR_RMP_Field is A0B.Types.SVD.UInt2;
