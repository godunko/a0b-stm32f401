...
package A0B.STM32F401.SVD.USB_OTG_FS is
   pragma Preelaborate;
   ...
   subtype FS_DCFG_DSPD_Field is A0B.Types.SVD.UInt2;
   subtype FS_DCFG_DAD_Field is A0B.Types.SVD.UInt7;
   subtype FS_DCFG_PFIVL_Field is A0B.Types.SVD.UInt2;
   ...
   type FS_DCFG_Register is record
      ...
      --  unspecified
      Reserved_13_31 : A0B.Types.SVD.UInt19 := 16#1100#;
   end record
   ...
   subtype FS_DCTL_TCTL_Field is A0B.Types.SVD.UInt3;
   ...
   subtype FS_DSTS_ENUMSPD_Field is A0B.Types.SVD.UInt2;
   subtype FS_DSTS_FNSOF_Field is A0B.Types.SVD.UInt14;
   ...
   subtype FS_DAINT_IEPINT_Field is A0B.Types.SVD.UInt16;
   subtype FS_DAINT_OEPINT_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FS_DAINTMSK_IEPM_Field is A0B.Types.SVD.UInt16;
   subtype FS_DAINTMSK_OEPINT_Field is A0B.Types.SVD.UInt16;
   ...
   subtype DVBUSDIS_VBUSDT_Field is A0B.Types.SVD.UInt16;
   ...
   subtype DVBUSPULSE_DVBUSP_Field is A0B.Types.SVD.UInt12;
   ...
   subtype DIEPEMPMSK_INEPTXFEM_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FS_DIEPCTL0_MPSIZ_Field is A0B.Types.SVD.UInt2;
   subtype FS_DIEPCTL0_EPTYP_Field is A0B.Types.SVD.UInt2;
   subtype FS_DIEPCTL0_TXFNUM_Field is A0B.Types.SVD.UInt4;
   ...
   subtype DIEPTSIZ0_XFRSIZ_Field is A0B.Types.SVD.UInt7;
   subtype DIEPTSIZ0_PKTCNT_Field is A0B.Types.SVD.UInt2;
   ...
   subtype DTXFSTS_INEPTFSAV_Field is A0B.Types.SVD.UInt16;
   ...
   subtype DIEPCTL1_MPSIZ_Field is A0B.Types.SVD.UInt11;
   subtype DIEPCTL1_EPTYP_Field is A0B.Types.SVD.UInt2;
   subtype DIEPCTL1_TXFNUM_Field is A0B.Types.SVD.UInt4;
   ...
   subtype DIEPTSIZ_XFRSIZ_Field is A0B.Types.SVD.UInt19;
   subtype DIEPTSIZ_PKTCNT_Field is A0B.Types.SVD.UInt10;
   subtype DIEPTSIZ_MCNT_Field is A0B.Types.SVD.UInt2;
   ...
   subtype DIEPCTL_MPSIZ_Field is A0B.Types.SVD.UInt11;
   subtype DIEPCTL_EPTYP_Field is A0B.Types.SVD.UInt2;
   subtype DIEPCTL_TXFNUM_Field is A0B.Types.SVD.UInt4;
   ...
   subtype DOEPCTL0_MPSIZ_Field is A0B.Types.SVD.UInt2;
   subtype DOEPCTL0_EPTYP_Field is A0B.Types.SVD.UInt2;
   ...
   type DOEPINT_Register is record
      ...
      --  unspecified
      Reserved_7_31 : A0B.Types.SVD.UInt25 := 16#1#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
   ...
   subtype DOEPTSIZ0_XFRSIZ_Field is A0B.Types.SVD.UInt7;
   subtype DOEPTSIZ0_STUPCNT_Field is A0B.Types.SVD.UInt2;
   ...
   subtype DOEPCTL_MPSIZ_Field is A0B.Types.SVD.UInt11;
   subtype DOEPCTL_EPTYP_Field is A0B.Types.SVD.UInt2;
   ...
   subtype DOEPTSIZ_XFRSIZ_Field is A0B.Types.SVD.UInt19;
   subtype DOEPTSIZ_PKTCNT_Field is A0B.Types.SVD.UInt10;
   subtype DOEPTSIZ_RXDPID_STUPCNT_Field is A0B.Types.SVD.UInt2;
   ...
   type FS_GAHBCFG_Register is record
      ...
      GINT          : Boolean := False;
      --  unspecified
      Reserved_1_6  : A0B.Types.SVD.UInt6 := 16#0#;
      --  TxFIFO empty level
   ...
   subtype FS_GUSBCFG_TOCAL_Field is A0B.Types.SVD.UInt3;
   subtype FS_GUSBCFG_TRDT_Field is A0B.Types.SVD.UInt4;
   ...
   type FS_GUSBCFG_Register is record
      ...
      --  unspecified
      Reserved_14_28 : A0B.Types.SVD.UInt15 := 16#0#;
      --  Force host mode
      FHMOD          : Boolean := False;
      --  Force device mode
      FDMOD          : Boolean := False;
   ...
   subtype FS_GRSTCTL_TXFNUM_Field is A0B.Types.SVD.UInt5;
   ...
   type FS_GRSTCTL_Register is record
      ...
      --  unspecified
      Reserved_11_30 : A0B.Types.SVD.UInt20 := 16#40000#;
   ...
   subtype FS_GRXSTSR_Device_EPNUM_Field is A0B.Types.SVD.UInt4;
   subtype FS_GRXSTSR_Device_BCNT_Field is A0B.Types.SVD.UInt11;
   subtype FS_GRXSTSR_Device_DPID_Field is A0B.Types.SVD.UInt2;
   subtype FS_GRXSTSR_Device_PKTSTS_Field is A0B.Types.SVD.UInt4;
   subtype FS_GRXSTSR_Device_FRMNUM_Field is A0B.Types.SVD.UInt4;
   ...
   subtype FS_GRXSTSR_Host_EPNUM_Field is A0B.Types.SVD.UInt4;
   subtype FS_GRXSTSR_Host_BCNT_Field is A0B.Types.SVD.UInt11;
   subtype FS_GRXSTSR_Host_DPID_Field is A0B.Types.SVD.UInt2;
   subtype FS_GRXSTSR_Host_PKTSTS_Field is A0B.Types.SVD.UInt4;
   subtype FS_GRXSTSR_Host_FRMNUM_Field is A0B.Types.SVD.UInt4;
   ...
   subtype FS_GRXFSIZ_RXFD_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FS_GNPTXFSIZ_Device_TX0FSA_Field is A0B.Types.SVD.UInt16;
   subtype FS_GNPTXFSIZ_Device_TX0FD_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FS_GNPTXFSIZ_Host_NPTXFSA_Field is A0B.Types.SVD.UInt16;
   subtype FS_GNPTXFSIZ_Host_NPTXFD_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FS_GNPTXSTS_NPTXFSAV_Field is A0B.Types.SVD.UInt16;
   subtype FS_GNPTXSTS_NPTQXSAV_Field is A0B.Types.SVD.Byte;
   subtype FS_GNPTXSTS_NPTXQTOP_Field is A0B.Types.SVD.UInt7;
   ...
   subtype FS_HPTXFSIZ_PTXSA_Field is A0B.Types.SVD.UInt16;
   subtype FS_HPTXFSIZ_PTXFSIZ_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FS_DIEPTXF_INEPTXSA_Field is A0B.Types.SVD.UInt16;
   subtype FS_DIEPTXF_INEPTXFD_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FS_HCFG_FSLSPCS_Field is A0B.Types.SVD.UInt2;
   ...
   subtype HFIR_FRIVL_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FS_HFNUM_FRNUM_Field is A0B.Types.SVD.UInt16;
   subtype FS_HFNUM_FTREM_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FS_HPTXSTS_PTXFSAVL_Field is A0B.Types.SVD.UInt16;
   subtype FS_HPTXSTS_PTXQSAV_Field is A0B.Types.SVD.Byte;
   subtype FS_HPTXSTS_PTXQTOP_Field is A0B.Types.SVD.Byte;
   ...
   subtype HAINT_HAINT_Field is A0B.Types.SVD.UInt16;
   ...
   subtype HAINTMSK_HAINTM_Field is A0B.Types.SVD.UInt16;
   ...
   subtype FS_HPRT_PLSTS_Field is A0B.Types.SVD.UInt2;
   subtype FS_HPRT_PTCTL_Field is A0B.Types.SVD.UInt4;
   subtype FS_HPRT_PSPD_Field is A0B.Types.SVD.UInt2;
   ...
   subtype FS_HCCHAR_MPSIZ_Field is A0B.Types.SVD.UInt11;
   subtype FS_HCCHAR_EPNUM_Field is A0B.Types.SVD.UInt4;
   subtype FS_HCCHAR_EPTYP_Field is A0B.Types.SVD.UInt2;
   subtype FS_HCCHAR_MCNT_Field is A0B.Types.SVD.UInt2;
   subtype FS_HCCHAR_DAD_Field is A0B.Types.SVD.UInt7;
   ...
   subtype FS_HCTSIZ_XFRSIZ_Field is A0B.Types.SVD.UInt19;
   subtype FS_HCTSIZ_PKTCNT_Field is A0B.Types.SVD.UInt10;
   subtype FS_HCTSIZ_DPID_Field is A0B.Types.SVD.UInt2;
   ...
   is record
      ...
      --  core ID register
      FS_CID              : aliased A0B.Types.SVD.UInt32;
      --  OTG_FS Host periodic transmit FIFO size register (OTG_FS_HPTXFSIZ)
...
end A0B.STM32F401.SVD.USB_OTG_FS;
