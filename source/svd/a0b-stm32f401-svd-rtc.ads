...
package A0B.STM32F401.SVD.RTC is
   pragma Preelaborate;
   ...
   subtype CALIBR_DC_Field is A0B.Types.SVD.UInt5;
   ...
   subtype TAFCR_TAMPFREQ_Field is A0B.Types.SVD.UInt3;
   subtype TAFCR_TAMPFLT_Field is A0B.Types.SVD.UInt2;
   subtype TAFCR_TAMPPRCH_Field is A0B.Types.SVD.UInt2;
